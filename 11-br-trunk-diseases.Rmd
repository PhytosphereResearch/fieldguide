...
------------------- 2026. Foamy bark canker. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
------------ 2026. Fusarium dieback. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
--------------. 2026. Bacterial canker of oak / "Acute oak decline". In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
(ref:BrDis3H) Dead branches on California black oak caused by Diplodia canker. Photo:  Larry Costello, UCCE, retired.


(ref:BrDis4H) Dead branches on coast live oak caused by Diplodia canker. Photo:  Larry Costello, UCCE, retired.
...
```{r BrDis4H, out.width="75%", fig.asp=.75, fig.align="center", fig.cap="(ref:BrDis4H)"}
...
Swiecki, T.J.; Bernhardt, E.A. 2006. Botryosphaeria / Diplodia cankers. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
*Phytophthora ramorum* is currently distributed in California forests in counties with coastal influence from southern Monterey County to the Oregon border. The distribution of *P. ramorum* in extends north of Del Norte County into Curry County in southwest Oregon. *P. ramorum* causes bleeding cankers on the main stems of coast live, California black, Shreve, and canyon live oaks as well as tanoak. The disease associated with these trunk infections is known as sudden oak death (SOD), although not all trees that develop cankers will be killed by them. SOD occurs in mixed hardwood forests containing oaks that are in close association with California bay, and in forests with tanoak.

*P. ramorum* also causes lesions on leaves, twigs, and/or small stems of multiple native species, including tanoak, California bay, madrone, California huckleberry, manzanita, toyon, poison oak, Douglas-fir, and coast redwood. This type of infection is referred to as Ramorum blight. Ramorum blight also affects a wide variety of ornamentals, especially under nursery conditions, and has been found in nurseries in North America and Europe.  In the UK, *P. ramorum* causes foliar blighting and bleeding stem cankers on timber plantations of non-native larch (*Larix* spp.). It can also spread to other conifers growing near infected larch, including Douglas fir, grand fir, noble fir, and western hemlock. It also causes twig and foliar blighting of European sweet chestnut, causing canopy dieback and tree decline.  
...
Swiecki, T.J.; Bernhardt, E.A. 2025. Sudden oak death and Phytophthora stem cankers. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
Sunburn (sometimes called sunscald in California) can occur in most parts of California, but is more common in hot, interior valleys than along the coast.  Transplanted young oaks of most species can be affected.  Among mature trees, species with thin, relatively smooth outer bark, including coast live and interior live oak, are more likely to develop sunburn.  


```{r, fig.align='center', fig.asp=.75, fig.cap="California counties likely to have sunburn on oaks (orange shading) and approximate range of native oak species (green).", out.width='30%'}
knitr::include_graphics("images/distributions/sunburn.png")
```
...
(ref:TrDis15) Transplanted interior live oaks (24 inch box nursery stock) with sunburn damage on the southwest side of exposed trunks. Tree at far left shows canopy thinning and dieback associated with the sunburn canker that extends to 1.5 m from the base of the tree. Closeup (second from left) shows exposed wood under dead cracked bark and exit holes of wood-boring beetles. Images right of center show cankers with callus development around bark and cambium areas killed by sunburn and production of both basal and epicormic sprouts near the affected areas. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.

```{r TrDis15, out.width='95%', fig.asp=.75, fig.align='center', fig.cap = "(ref:TrDis15)"}
knitr::include_graphics("images/Disease-trunk/sunscaldQW_Roseville_phytosphere.jpg")
```
...
(ref:TrDis16B) Severe sunburn symptoms in a mature coast live oak trunk two years after a partial root failure of this tree changed the orientation of the trunk from nearly vertical to horizontal, exposing the previously shaded stem to full midday sun. Killed bark on the sun-exposed side shows cracking and staining from bleeding. The canopy of the now prostrate trunk remained green. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.

```{r TrDis16B, out.width='95%', fig.asp=.75, fig.align='center', fig.cap = "(ref:TrDis16B)"}
knitr::include_graphics("images/Disease-trunk/QA6-190 fail sunburn 10-20-03 c crop.jpg")
```



(ref:TrDis17A) Bark cut away from this bleeding area of a sunburn canker on a mature coast live oak stem shows scattered patches of  tissue death (necrosis) that is limited to the outermost layers of the live bark layer. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.

```{r TrDis17A, out.width='95%', fig.asp=.75, fig.align='center', fig.cap = "(ref:TrDis17A)"}
knitr::include_graphics("images/Disease-trunk/QA6-190 sunburn canker 10-6-04dPhytosphere.JPG")
```


#### Biology {-}

During tree growth and development, the structure of oak bark changes in response to its environment. Bark that is exposed to heating by sunlight normally develops a thicker layer of dead bark layers that insulate the underlying live bark (phloem) tissues and the cambium. Sunburn develops in portions of the bark of trees that are not adapted to high sun exposure and are abruptly subjected to high levels of solar radiation particularly in the summer and fall. Sunburn is more likely to develop in water-stressed trees and following episodes of unusually high temperatures. The combination of high temperatures, high solar intensity, and elevated levels of plant water stress result in heating of live bark and cambium to temperatures that kill these tissues, resulting in localized necrosis. In both young and mature trees, areas affected by sunburn may be subsequently attacked by wood boring beetles and colonized by canker or wood decay fungi.

Sunburn typically develops in parts of trees with relatively thin outer bark, which provides less protection from heating caused by sun exposure. This includes young stems of many oaks and mature stems of coast live and interior live oak. Species with relatively thick outer layers of corky or flaky bark seldom develop sunburn.  

Sunburn commonly develops on the south and west sides of sun-exposed lower trunks of newly transplanted young trees. This is typically associated with stock that has been being propagated under nursery conditions where the lower trunk has been shaded by surrounding plants, which is not adapted to extended periods of solar heating. Such trees also typically lack low branches needed to shade the trunk and experience greater levels of water stress after planting than they did in the nursery. 

In mature oaks such as coast live and interior live oak, sunburn is most likely to develop where areas of previously shaded thin bark become exposed to high sun intensity as the result of pruning, tree failure, or other rapid changes in canopy shading. Small areas affected by sunburn may recover after a few years if the underlying cambium is not affected. If killed areas of cambium are small, the edges of the affected areas can develop callus which may eventually cover the affected area.   


#### Importance {-}

Sunburn that develops on transplanted nursery stock can contribute to poor vigor, decline, or death, especially in small trees. In mature trees, invasion of larger sunburned areas by secondary agents can prevent recovery of the affected area and may contribute to decline or failure especially in low-vigor trees.


#### Citation {-}

Swiecki, T.J.; Bernhardt, E.A. 2026. Sunburn. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
Swiecki, T.J.; Bernhardt, E.A. 2025. Wetwood. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
Swiecki, T.J.; Bernhardt, E.A. 2025. *Annulohypoxylon thouarsianum*. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
--------------- 2026. *Biscogniauxia mediterranea*. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
*Inocutis dryophila* is reported on coast live, interior live, canyon live, California black, Oregon white, blue, and valley oak in California.  It is primarily found on living oaks, but is also reported on maple, *Populus*, *Prunus*, *Schinus*, and willow.
...
(ref:BrDis1B) Blue oak with typical elongate canker rot cankers and fruiting body of *Inocutis dryophila*. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.
...
*Inocutis dryophila* basidiocarps are annual, hoof-shaped, up to 11 by 19 by 9 cm, usually solitary, and firm and corky when fresh (figure  \@ref(fig:BrDis2B).  The upper surface of the basiodiocarp (pileus) is buff to reddish-brown.  The lower surface is covered with a layer of tubes up to 3 cm thick that terminate in a smooth layer of small angular pores (1—3 per mm).  The pore surface is white to buff at first, but becomes dark reddish-brown with age.  Basidiospores are brownish.  The context (sterile tissue between the tube layer and the pileus) mostly consists of a hard, granular core of intermixed brown and whitish mycelium.



(ref:BrDis5B) Close-up of *Inocutis dryophila* fruiting on interior live oak. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.
...
Basidiocarps mature mainly between fall and spring.  *I. dryophila* typically fruits on living stems.  *I. andersonii* only fruits on dead wood, including dead portions of living stems, dead branches, or on stems that have failed due to decay.  Basidiospores are produced along the inner walls of the tubes in the basidiocarp.  They are discharged though the pores on the lower surface of the basidiocarp and are disseminated by air currents.  Basidiospores initiate new infections, most likely by invading wounds such as broken branch stubs or pruning cuts.  

#### Importance {-}

*I. andersonii* and *I. dryophila* are among the most frequently observed wood decay fungi on living oaks in many types of hardwood forests.  These fungi are serious pathogens of California oaks and are associated with oak decline, failure, and mortality in many California oak woodlands.

#### Citation {-}

Swiecki, T.J.; Bernhardt, E.A. 2026. Canker rots. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
Swiecki, T.J.; Bernhardt, E.A. 2025. Orange hobnail canker. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
Swiecki, T.J.; Bernhardt, E.A. 2025. *Fomitiporia robusta*. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
Swiecki, T.J.; Bernhardt, E.A. 2025. *Fuscoporia gilva*. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
Swiecki, T.J.; Bernhardt, E.A. 2025. Hedgehog fungus. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
Swiecki, T.J.; Bernhardt, E.A. 2025. Western sulfur shelf fungus. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
Swiecki, T.J.; Bernhardt, E.A. 2025. Oak mistletoe.  In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.

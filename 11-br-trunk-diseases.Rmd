...
Sunscald commonly develops on the south and west sides of sun-exposed lower trunks of newly transplanted young trees. This is typically associated with stock that has been being propagated under nursery conditions where the lower trunk has been shaded by surrounding plants, which is not adapted to extedned periods of solar heating. Such trees also typically lack low branches needed to shade the trunk and experience greater levels of water stress after planting than they did in the nursery. 

In mature oaks such as coast live and interior live oak, sunburn is most likely to develop where areas of previously shaded thin bark become exposed to high sun intensity as the result of pruning, tree failure, or other rapid changes in canopy shading. Small areas affected by sunburn may recover after a few years if the underlying cambium is not affected. If killed areas of cambium are small, the egdes of the affected areas can develop callus which may eventually cover the affected area.   

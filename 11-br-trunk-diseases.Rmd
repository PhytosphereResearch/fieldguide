...
Sunscald can occur in most parts of California, but is more common in hot, interior valleys than along the coast.  Transplanted young oaks of most species can be affected.  Among mature trees, species with thin, realtively smooth outer bark, including coast live and interior live oak, are more likely to develop sunscald.  


```{r, fig.align='center', fig.asp=.75, fig.cap="California counties likely to have sunscald on oaks (orange shading) and approximate range of native oak species (green).", out.width='30%'}
knitr::include_graphics("images/distributions/sunscald.png")
```
...
(ref:TrDis15) Transplanted interior live oaks (24 inch box nursery stock) with sunburn damage on the southwest side of exposed trunks. Tree at far left shjows canopy thinning adn dieback assocaited with the sunburn canker that extends to 1.5 m from the base of the tree. Closeup (second from left) shows exposed wood under dead craked bark and exit holes of wood-boring beetles. Images right of center show cankers with callus development around bark and cambium areas killed by sunburn and production of both basal and epicormic sproutsnear the affected areas. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.
...
(ref:TrDis16B) Severe sunburn symptoms in a mature coast live oak stem two years after a partial root failure of this tree changed the orintation of the stem fomr nearly vertical to horizonal, exposing the previously shaded stem to full midday sun. Killed bark on the sun exposed side shows cracking and staining from bleeding. The canopy of the now prostrate stem remained green. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.
...
During tree growth and development, the structure of oak bark changes in response to its environment. Bark that is exposed to heating by sunlight normally develops a thicker layer of dead bark layers that insulate the underlying live bark (phloem) tissues and the cambium. Sunscald develops in portions of the bark of trees that are not adapted to high sun exposure and are abruptly subjected to high levels of solar radiation particularly in the summer and fall. Sunscald is more likely to develop in water-stressed trees and following episodes of unusually high temperatures. The combination of high temperatures, high solar intensity, and elevated levels of plant water stress result in heating of live bark and cambium to temperatures that kill these tissues, resulting in localized necrosis. In both young and mature trees, areas affected by sunscald may be subsequently attacked by wood boring beetles and colonized by canker or wood decay fungi.

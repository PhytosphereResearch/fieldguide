...
Most *Tubakia* species are characterized by the production of rounded, shield-shaped asexual fungal fruiting structures (pycnothyria) where asexual spores (conidia) are formed.  When *T. californica* was originally described, pycnothyria had not been observed and were not described [@braun2018tubakia]. Small pycnothyria have since been found on petioles in a single location in Sonoma Co. Pycnothyria observed on affected leaves and petioles were tiny, black, and crustose, usually (50–)80–200(–220) μm diam (about the width of a human hair) and resemble pycnidia (flask-shaped fruiting bodies with a narrow opening). The pycnidia-like structures of *T. californica*  release conidia through irregular fissures. Conidia are 8-15 x 4.5-7 µm, ellipsoid to ellipsoid-oval, and initially subhyaline (not quite clear) becoming greenish as they age [@braun2018tubakia].   

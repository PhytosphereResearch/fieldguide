...
*Microstroma album* is reported on oaks in many parts of the world, including Algeria, Canada, Europe, Japan, New Zealand, and the U.S.  (e.g. (@shaw1960) In California, it has been reported on blue oak and valley oak from Shasta to Los Angeles counties, but mostly in coastal counties (figure x). It has been found on oracle oak (Q. × morehus) in Solano County.
...
(ref:LfDisMa1) Symptoms of *Microstroma album* infection on upper (left) and lower (right) leaf surfaces of *Quercus* × *morehus*. Yellow stipple develops on the upper leaf surface while tiny white spots (fruiting structures and spores of the fungus) develop in corresponding locations on the lower leaf surface.   Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.

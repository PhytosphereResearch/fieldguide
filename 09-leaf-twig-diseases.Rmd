...
*Cystotheca lanestris* (previously *Sphaerotheca lanestris*) is widespread and has been reported from most oaks in California. It has also been reported from oaks in Arizona, Washington, and Mexico.
...
*E. trinae* chasmothecia are abundant, yellow-brown, somewhat transparent, small (60 μm diameter), and lack appendages.  Each chasmothecium contains two to three saclike structures (asci), each of which contains two spores (ascospores).  *E. trinae* produces almost no conidia.  

*C. lanestris* chasmothecia are of intermediate size (95 μm diameter) with unbranched, flexuous appendages. Each chasmothecium has a single ascus with eight ascospores. Conidia are abundant, barrel-shaped, and stick together end to end in chains.
...
chasmothecium. Ends of mature appendages have many short dichotomous branches (figure \@ref(fig:LfDisPm8)). Each ascus has four to five ascospores. Conidia are roughly cylindrical to somewhat barrel shaped.
 
*P. angulata* chasmothecia are large (about 270 μm diameter) and have needle-like appendages that are inflated at the base. Chasmothecia contain about 10 asci, each with two ascospores. Conidia are roughly cylindrical.

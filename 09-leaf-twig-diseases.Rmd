...
```{r, fig.align='center', fig.asp=.75, fig.cap="California counties with known occurences of anthracnose fungi (orange shading) and approximate range of native oak species (green).", out.width='30%'}
knitr::include_graphics("images/distributions/Tapcae.png")
```
...
(ref:LfDis2C) Branch dieback of coast live oak caused by *Cryptocline cinerescens*. Photo:  Bruce Hagen, CalFire, retired

```{r LfDis2C, out.width='75%', fig.asp=.75, fig.align='center', fig.cap = "(ref:LfDis2C)"}
knitr::include_graphics("images/Disease-leaftwig/CRYPTOCLINE B HAGEN.jpg")
```


(ref:LfDis2D) Branch dieback of coast live oak caused by *Cryptocline cinerescens*. Photo:  Bruce Hagen, CalFire, retired

```{r LfDis2D, out.width='75%', fig.asp=.75, fig.align='center', fig.cap = "(ref:LfDis2D)"}

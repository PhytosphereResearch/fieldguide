...
*Microstroma album* is reported on oaks in many parts of the world, including Algeria, Canada, Europe, Japan, New Zealand, and the U.S. In California, it has been reported on blue oak and valley oak from Shasta to Los Angeles counties, but mostly in coastal counties . It has been found on oracle oak (*Q.* × *morehus*) in Solano County.



```{r, fig.align='center', fig.asp=.75, fig.cap="Approximate ranges of *Microstroma album* (orange shading) and native oak species (green) in California.", out.width='30%'}
knitr::include_graphics("images/distributions/Micalb.png")
```


#### Symptoms {-}

Leaves infected with *M. album* (figure \@ref(fig:LfDisMa1),  \@ref(fig:LfDisMa2)) develop chlorotic (yellow) stippling or spots on the upper surface. Initially, these are angular and bounded by small leaf veins. These spots may merge to form yellow patches. The fungal fruiting bodies appear on the lower leaf surface as raised white spots. The tiny fruiting bodies emerge through stomata, so there is no cell rupture or necrosis associated with them.


(ref:LfDisMa1) Symptoms of *Microstroma album* infection on upper (left) and lower (right) leaf surfaces of *Quercus* × *morehus*. Yellow stipple develops on the upper leaf surface while tiny white spots (which are fruiting structures and spores of the fungus) develop in corresponding locations on the lower leaf surface.   Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.

```{r LfDisMa1, out.width='75%', fig.asp=.75, fig.align='center', fig.cap = "(ref:LfDisMa1)"}
knitr::include_graphics("images/Disease-leaftwig/Microstroma album_Quercus Xmorehus_Phytosphere.jpg")
```


(ref:LfDisMa2) Closeup of clusters of tiny tufted fruiting bodies of *Microstroma album* on lower leaf surface of *Quercus* × *morehus*. Fruiting bodies consist of masses of basidia and sterile hyphae that emerge through stomata.   Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.

```{r LfDisMa2, out.width='75%', fig.asp=.75, fig.align='center', fig.cap = "(ref:LfDisMa2)"}
knitr::include_graphics("images/Disease-leaftwig/Microstroma album_QUMOleafimages0003_Phytosphere.jpg")
```


#### Agent Description {-}

*M. album* is classified as a member of the Microstromatales, an order in the class Exobasidiomycetes in the Basidiomycota. The fungus alternates between two life forms: mycelial and yeast stages. The mycelial stage is diploid and an obligate pathogen of oaks, whereas the yeast stage arises from budding haploid basidiospores and is a free-living saprophyte, historically referred to as *Rhodotorula bacarum*. The yeast phase can be found on the leaf surface (phylloplane). Fruiting bodies consist of basidia (20-25 μm long) and sterile hyphae that emerge through the stomata in layers [@begerow2001]. Each basidium gives rise to 4-6 hyaline basidiospores (5-7 × 3 μm) containing 2 guttules ([@ellis1990] as cited by [@fodor2014]). Some early mycologists interpreted these unusual fruiting bodies as asexual fruiting bodies. Due to controversy about its proper taxonomic placement, this fungus was assigned several different names in different taxonomic groups before the original name *M. album* was restored [@fodor2014].

#### Biology {-}

Aside from its complicated life history described above, little is known about its biology. Infection and fruiting seem to be favored by moisture

#### Importance {-}

On *Q*. × *morehus*, the fungus appears in late winter on overwintering leaves that are shed in early spring, so it has little or no impact.


#### Citation {-}

Bernhardt, E.A; Swiecki, T.J. 2026. *Microstroma album*.  In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
Powdery mildews are widespread and occur on most oaks throughout California.  The taxonomy of the powdery mildews has undergone multiple revisions over the years. Most recently, the use of gene sequencing has resulted in a number of name changes and reclassifications. Except for studies on *Cystotheca*, few samples were included from California oaks, so it is possible our current understanding of species present in California could change in the future.
...
*Cystotheca lanestris* (formerly *Sphaerotheca lanestris*) is widespread and has been reported from most oaks in California. It has also been reported from oaks in Arizona, Washington, and Mexico.

*Erisyphe trinae* (formerly *Brasiliomyces trina*) is relatively uncommon and has been reported from Arizona and California. Reported hosts include coast live oak, canyon live oak, and tanoak , as well as *Q. alba* (white oak, native to Canada and eastern and central U.S.) and *Q. hypoleucoides* (silverleaf oak, native to Arizona, New Mexico, western Texas, and northern Mexico). 

Historically, many powdery mildew specimens on oaks in California were assigned to *Microsphaera penicillata* (= *M. alni*). *M. penicillata* was reported on a wide variety of California native oaks, including coast live, interior live, blue, valley, leather, Engelmann, Oregon white, California black, and various scrub oaks.  It was also reported on several cultivated non-native oaks, including English oak. In 1982, *M. penicillata* was split into numerous host-specific species. The species reported on oaks in N. America were *M. alphitoides*, *M. abbreviata*, *M. calocladophora*, and *M. extensa* varieties *extensa* and *curta* [@braun1982]. All of these were transferred to the genus *Erysiphe* [@braun2000powdery].  *E. extensa* var. *curta* was confirmed on blue, valley, Oregon white, and California black oak.  

A re-examination of some species of *Erysiphe*  in North America by genetic sequencing led to *E. extensa* var. *curta* being included in the species *E. densissima*, which is restricted to a few *Quercus* species in the eastern U.S. [@bradshaw2025powdery]. The western specimens previously identified as *E. extensa* var. *curta* were assigned to the newly described created species *E. occidentalis* [@bradshaw2025powdery].  Genetic sequencing also indicated that *E. penicillata* type material was restricted to *Alnus* host species in Europe [@bradshaw2024microsphaera1]. That left the  material from California previously identified as *M. penicillata* without a current species name.  Without re-examination of the historic specimens, it is not possible to reassign material previously identified as *M. penicillata* to current species names.  

*Phyllactinia angulata*  (= *Phyllactinia corylea*, *P. guttata*) is distributed throughout North America on trees in the family Fagaceae (includes oak, chestnut, beech) and is reported in California on coast live, California black, and valley oak [@bradshaw2025phyllactinieae].  According to @braun1987, the species of *Phyllactinia* previously identified as *P. corylea* on oaks in California should be assigned to this species. 
...
*E. trinae* produces well defined, grayish to brownish-white, rounded to irregular colonies on the upper leaf surface (figure \@ref(fig:LfDisPm1),  \@ref(fig:LfDisPm2)).


(ref:LfDisPm1) *Erysiphe trinae* on coast live oak.  Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.

```{r LfDisPm1, out.width='75%', fig.asp=.75, fig.align='center', fig.cap = "(ref:LfDisPm1)"}
knitr::include_graphics("images/Disease-leaftwig/E trinae QA china Camp 4-5-05d_Phytosphere.jpg")
```


(ref:LfDisPm2)  *Erysiphe trinae* on coast live oak.  Masses of brown fruiting bodies (chasmothecia) give a mottled brown or grayish appearance to the fungal mycelium.  Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.

```{r LfDisPm2, out.width='75%', fig.asp=.75, fig.align='center', fig.cap = "(ref:LfDisPm2)"}
knitr::include_graphics("images/Disease-leaftwig/E trinae QA china Camp 4-5-05b_Phytosphere.jpg")
```



*E. occidentalis* mycelium is normally present on the upper leaf surface.  It commonly forms a persistent thin whitish film over the entire leaf (figure \@ref(fig:LfDisPm6),  \@ref(fig:LfDisPm7)). *P. angulata* mycelium primarily occurs on the lower leaf surface but is also found on the upper surface. 

(ref:LfDisPm6) *Eryisphe occidentalis* on valley oak.  Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.
...
(ref:LfDisPm7)  *Eryisphe occidentalis* on blue oak.  Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.

```{r LfDisPm7, out.width='75%', fig.asp=.75, fig.align='center', fig.cap = "(ref:LfDisPm7)"}
knitr::include_graphics("images/Disease-leaftwig/Erysiphe occidentalis on Q douglasii Nov 18 2003 d_Phytosphere.jpg")
```
...
Powdery mildew fungi on California oaks are differentiated primarily on the basis of their sexual fruiting bodies (chasmothecia, also referred to as cleistothecia in older literature) and to a lesser degree on their microscopic asexual spores (conidia). Chasmothecia are just large enough to see without magnification, but observing their diagnostic appendages and other features requires a microscope.

*C. lanestris* chasmothecia are of intermediate size (95 μm diameter) with unbranched, flexuous appendages. Each chasmothecium encloses a single saclike structure (ascus) containing eight spores (ascospores). Conidia are abundant, barrel-shaped, and stick together end to end in chains.

*E. trinae* chasmothecia are abundant, yellow-brown, somewhat transparent, small (60 μm diameter), and lack appendages.  Each chasmothecium contains two to three asci, each of which contains two ascospores.  *E. trinae* produces almost no conidia.  

*E. occidentalis* chasmothecia are intermediate to fairly large (116-156 μm diameter). Each has  6 to 18 somewhat stiff appendages which are one to 2.5 times as long as the
chasmothecium. Ends of mature appendages have many short dichotomous branches (figure \@ref(fig:LfDisPm8)). Each chasmothecium contains six asci, each of which contain four to five ascospores. Conidia are ellipsoid-cylindrical, with ornamented walls that form yellowish warts and ridges when dry.
 
*P. angulata* chasmothecia are large (about 270 μm diameter) and have needle-like appendages that are inflated at the base. Chasmothecia contain about 10 asci, each with two ascospores. Conidia have an angular dumbbell shape, being somewhat constricted in the center. 


(ref:LfDisPm8) Micrograph of *Erysiphe occidentalis* chasmothecia with hyaline, dichotomously branched appendages; developing appendages are unbranched.  Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.

```{r LfDisPm8, out.width='75%', fig.asp=.75, fig.align='center', fig.cap = "(ref:LfDisPm8)"}
knitr::include_graphics("images/Disease-leaftwig/Eryisphe occidentalis from QL Nov-14-2003c_Phytosphere.jpg")
```
...
oak and on some non-native oaks. Oaks in the subgenus Lobatae (red/black oaks) are generally more susceptible than those in subgenus Quercus (white oaks).
...
(ref:LfDis2A) Oak leaf blister symptoms on the upper surfaces of *Quercus* × *morehus* leaves. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.
...
(ref:LfDis2B) Oak leaf blister symptoms on the lower surfaces of *Quercus* × *morehus* leaves. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.
...
Swiecki, T.J.; Bernhardt, E.A. 2026. Oak leaf blister. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.
...
(ref:LfDis5C) Shoot tip dieback caused by *Tubakia californica* on California black oak. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.
...
(ref:LfDis5B) Persistent previous year dead leaves (marcescence) infected by *Tubakia californica* on California black oak in August. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.
...
(ref:LfDis1) Early leaf browning and defoliation associated with drought stress in a stand of blue oaks. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.
...
(ref:LfDis2) Early leaf browning and defoliation associated with drought stress in a stand of blue oaks. Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.

...
```{r, fig.align='center', fig.asp=.75, fig.cap="California counties with known occurences of  powdery mildew  (orange shading) and approximate range of native oak species (green).", out.width='30%'}

...
(ref:CurCydQlPR) This valley oak acorn contained larvae of five filbert weevils and one filbertworm (second from left). The exit hole (right) indicates that at least one additional larva has already exited the acorn.


```{r CurCydQlPR, out.width='80%', fig.asp=.75, fig.align='center', fig.cap = "(ref:CurCydQlPR)"}
...
(ref:CupaQdPR) Filbert weevil and associated damage to a blue oak acorn. 

(ref:CurAdPR) Adult filbert weevil. 

```{r CupaQdPR, out.width='80%', fig.asp=.75, fig.align='center', fig.cap = "(ref:CupaQdPR)"}
knitr::include_graphics("images/Insect-acorn/Curpar_QUDO_PR_9-89scan.jpg")
```

```{r CurAdPR, out.width='80%', fig.asp=.75, fig.align='center', fig.cap = "(ref:CurAdPR)"}
...
(ref:CylaQlPR) Filbertworm larva and damage to valley oak acorn. 

```{r CylaQlPR, out.width='80%', fig.asp=.75, fig.align='center', fig.cap = "(ref:CylaQlPR)"}
...
(ref:CylaAdPuDO) Filbertworm larva and damage to valley oak acorn. 

```{r CylaAdPuDO, out.width='80%', fig.asp=.75, fig.align='center', fig.cap = "(ref:CylaQlPR)"}

...
```{r, fig.align='center', fig.asp=.75, fig.cap="Approximate ranges of filbert weevil (orange shading) and native oak species (green) in California.", out.width='30%'}
...
```{r, fig.align='center', fig.asp=.75, fig.cap="Approximate ranges of filbertworm (orange shading) and native oak species (green) in California.", out.width='30%'}
knitr::include_graphics("images/distributions/statewide.png")
```

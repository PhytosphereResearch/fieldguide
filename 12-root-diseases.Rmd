...
At least 30 species of soilborne root-rotting *Phytophthora* species have been recovered from root systems of oaks in California. Most of these species have been baited from root systems of nursery grown plants in nurseries or in plantings in wildlands or horticultural landscapes. Some species, including *P. cinnamomi*, *P. cactorum*, and *P. cambivora*, have spread into native landscapes far beyond points of introduction. Other *Phytophthora* species found in California that appear to infect one or more native oak species include *P. cactorum*, *P. citrophthora* *P. citricola*, *P. kelmanii*, *P. mediterranea*, *P. nicotianae*, *P. quercetorum*, *P. quercina*, and *P.* taxon agrifolia. Native oaks known to be affected by one or more root-rotting *Phytophthora* species include blue, valley, scrub (*Q. berberidifolia*), coast live, and interior live oaks, but susceptibilities of most native oak species to these pathogens have not been assessed.
...
(ref:RtDis1C) *Phytophthora cinnamomi* cankers at base of cork oak.  Bark around one canker has been partially removed on left side of trunk.   Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research. 

```{r RtDis1C, out.width='75%', fig.asp=.75, fig.align='center', fig.cap = "(ref:RtDis1C)"}
knitr::include_graphics("images/Disease-root/PhyCin_P CINNAMOMI CORK OAK_Phytosphere.jpg")
```


(ref:RtDis2C) Bleeding *Phytophthora cinnamomi* cankers on this *Quercus robur* (English oak) extended more than 2 m above the soil. In image at right, outer bark has been cut away from some cankers to reveal dark phloem tissue killed by the pathogen. Although outer phloem necrosis is not continuous, vertically aligned cankers are connected by infected inner phloem or xylem tissues.      Photo: Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research. 

```{r RtDis2C, out.width='75%', fig.asp=.75, fig.align='center', fig.cap = "(ref:RtDis2C)"}

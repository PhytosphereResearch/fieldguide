...
Feeding by most oak phylloxeras in California induces small (about 1 mm diameter) yellow or brownish spots on oak leaves that are visible on both the upper and lower surfaces (figure  \@ref(fig:SapFdrs1)). Depending on the *Phylloxera* species, spots may be located primarily along veins or spread over the entire leaf surface. Spots become most noticeable in mid summer to early fall. If population levels are high enough, part or all of an affected leaf may turn brown and die (figure  \@ref(fig:SapFdrs2)). 

*P. glabra* first generation (fundatrices) nymphs and adults feed near leaf edges, which causes the leaf edge to fold over, but without the reddining and thickening caused by the wooly oak aphid *Stegophylla essigi*. *P. stanfordiana* was described as occurring on twigs of *Q. douglasii* [@ferris1919].  

Wingless adults and immatures normally occur on the undersides of affected leaves. All are less than 1 mm long, somewhat pear-shaped, and mostly orange to yellow, but some are brownish. Small ovoid yellowish to orange eggs may also be present, either scattered or in somewhat circular patterns.    
...
(ref:SapFdrs3A) Diagrams of seven *Phylloxera* species recorded on oaks in California from original drawings by @ferris1919 (*P. stanfordiana*) and @Duncan1922 (all others). Dorsal side of each insect is drawn left of the center line; the ventral side is drawn on the right. Scale bars to the left of each insect is hte reported body length.  Graphic (using published images): Tedmund J. Swiecki and Elizabeth A. Bernhardt, Phytosphere Research.
...
The NOrth American species of oak leaf phylloxera found in California are usually of minor importance to mature trees. However, heavy infestations on oak seedlings and saplings could reduce growth and vigor. .although damage to seedlings may be significant in some situations. The oak leaf phylloxera (*P. glabra*) is reported to be a severe pest of Oregon white oak in British Columbia, causing significant scorching and defoliation of mature trees.  *P. glabra* has not been reported in California as of 2006.

#### Citation {-}

Swiecki, T.J.; Bernhardt, E.A. 2025. Oak leaf phylloxera. In Swiecki, T.J., et al. (Eds.) Field Guide to Insects and Diseases of California Oaks, Online edition `r Sys.Date()`.

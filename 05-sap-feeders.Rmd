...
As detailed by @hillerislambers1966, the taxonomy of the *Stegophylla* species on oaks in California and elsewhere in North America has been confused through a series of misidentifications and classifications.  A woolly aphid on twigs of oaks in northern Illinois was named *Eriosoma querci* Fitch in 1859. However, Fitch described winged (alate) forms for this aphid that were in fact different, non-woolly species on non-oak hosts. This initiated a series of confused and conflicting reclassifications resulting in *E. querci* being transferred to the invalid name *Stegophylla querci* (Fitch), which was then incorrectly synonymized with a separate species, *Stegophylla quercicola*. @swain1919 described woolly oak aphids occurring on several California oak aphids species that formed pesudogall on leaf edges. He classified these as *Phyllaphis* (later *Stegophylla*) *quercicola*, although he indicated that the  "identity of this species has never been definitely established" and noted that *S. quercicola*  was thought to differ from the woolly oak aphids in California. @hillerislambers1966 determined that Swain's aphids were a distinct species, which he named *Stegophylla essigi*, but did not definitively resolve the nomenclature issues involving  *Stegophylla querci* and *S. quercicola*.  @quednau2010 replaced the invalid name *S. querci* with *S. davisi*, a species that occurs on oaks in eastern North America. He also clarified that *S. quercicola* applied oak woolly aphids in eastern North America.
...
Feeding by first generation *S. essigi* in spring causes the edges of young leaves to fold over to the upper side of the leaf, forming a protective shelter in which the aphids feed and where wax accumulates (figure  \@ref(fig:SapFdrs5)). These have been referred to as pseudogalls or galls. The pseudogall may show a reddish discoloration initially and may die eventually. Generations of aphids produced later in the season form unprotected small colonies on the lower and upper leaf surfaces [@hillrislambers1966, @swain1919].

*S. quercifoliae* infests the undersides of leaves. It does not form pseudogalls but can frequently be found in leaves folded by leafrolling caterpillars [@gillette1914]. Colonies produce profuse amounts of cottony white wool. Wingless females have bright red eyes.  Heavy infestations in young leaves may induce some curling or distortion.  





Masses of white wax filaments produced by *S. querci* and *S. quercifoliae* nymphs and adults are visible on infested leaves (figure  \@ref(fig:SapFdrs4)).  *S. querci* forms small, scattered colonies on upper or lower leaf surfaces.    Large colonies may cause leaves to curl.

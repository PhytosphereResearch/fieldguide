...
The taxonomy of the *Stegophylla* species on oaks in California and elsewhere has been confused since the woolly aphid *Eriosoma querci* Fitch was described on twigs of oaks from northern Illinois in 1859. However, he described winged (alate) forms that were of a different, non-woolly species. As detailed by @hillerislambers1966, this initiated a series of confused and conflicting reclassifications resulting in an invalid taxon *Stegophylla querci* (Fitch) being incorrectly synonymized with the distinct species *Stegophylla quercicola*. California woolly oak aphids described by Swain [@swain1919] as *Phyllapsis* (*Stegophylla*) *quercicola* were named  *Stegophylla essigi* by Hille Ris Lambers. Quednau [@quednau2010] used name *S. davisi* to replace the invalid name *S. querci*, but that species was limited to species found on oaks in eastern North America, as was the redefined *S. quercicola*. As a result, past records of *S. querci* and *S. quercicola* in California appear to be either *S. essigi* or *S. quercifoliae*, which have overlapping ranges.

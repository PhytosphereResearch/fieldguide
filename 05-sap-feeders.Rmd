...
*S. quercifoliae* is widely distributed in California but has been under-reported to date due to to the taxonomic confusion discussed below. Verified collections of *S. quercifoliae* have been made from blue, Engelmann, valley, coast live, interior live, and scrub oak. This aphid was originally described from specimens on scrub oa species in Colorado, and is also reported from Washington.    
...
*S. essigi* overwinters as eggs, although populations may continue to reproduce parthenogenically on evergreen oaks such as *Q. agrifolia*, especially in leaves tied together by caterpillar silk. Only the first generation that overwinters as eggs induces leaf edge pseudogalls. Several asexually-reproducing (viviparous) generations develop over the spring and summer, with sexual (oviparous) females and males being produced in fall. 
...
Early season damage from *S. essigi* pseudogalls on developing leaves. Heavy infestations of *S. quercifoliae* can produce conspicuous and possibly unsightly deposits of loose wax, especially late in the season. Feeding by woolly oak aphids and has no substantial impact on tree condition.
